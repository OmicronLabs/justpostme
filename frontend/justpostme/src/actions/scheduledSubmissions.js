...
export const FETCH_SCHEDULED_BEGIN = "FETCH_PENDING_BEGIN";
export const FETCH_SCHEDULED_SUCCESS = "FETCH_PENDING_SUCCESS";
export const FETCH_SCHEDULED_ERROR = "FETCH_PENDING_ERROR";
export const DELETE_SCHEDULED = "DELETE_PENDING";
